...
peaks3, maxgap=1000, multiple=F, NameOfPeaks1="TF1TF2", NameOfPeaks2="TF3")$Peaks1withOverlap
@
\end{scriptsize}
...
maxgap=0, totalTest=100, cex = 1, counts.col = "red",useFeature=FALSE)
@
\end{scriptsize}
...
\subsection{Task 4:  Obtain enriched gene ontology (GO) terms near the peaks}
