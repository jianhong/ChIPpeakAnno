...
#' @importFrom ggplot2 ggplot aes geom_bar geom_point scale_x_discrete scale_y_continuous geom_text xlab ylab theme_classic theme facet_grid expansion element_text
