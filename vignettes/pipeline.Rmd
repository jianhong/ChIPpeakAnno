...
freqs <- oligoFrequency(Hsapiens$chr1[50000:100000], MarkovOrder=3)
...
```
```{r simulation, fig.cap=generateFigureCaption("Histogram of Z-score of simulation data"), fig.width=6, fig.height=6}
